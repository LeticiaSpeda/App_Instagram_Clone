...
protocol AuthencationViewModel {
    var formIsValid: Bool { get }
    var buttonBackgrounColor: UIColor { get }
    var buttonTitleColor: UIColor { get }
}

struct LoginViewModel: AuthencationViewModel {
    var email: String?
    var password: String?
    ...
    var buttonBackgrounColor: UIColor {
...
struct RegistrationViewModel: AuthencationViewModel {
    var email: String?
    var password: String?
    var fullname: String?
    var username: String?
